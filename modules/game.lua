    ...
    local stars = {}
    local currentBgColor = {0, 0, 0.1, 0.4}
    ...
    function game.drawWinPopup()
        ...
        -- Draw "You Win!" text
        love.graphics.setColor(1, 1, 1)
        local winFont = love.graphics.newFont("source/fonts/Jersey10.ttf", 48)  -- Adjusted font size
        love.graphics.setFont(winFont)
        love.graphics.printf("You Win!", 0, 150, love.graphics.getWidth(), "center")
    
        -- Draw money earned text
        local moneyFont = love.graphics.newFont("source/fonts/Jersey10.ttf", 24)  -- Adjusted font size
        love.graphics.setFont(moneyFont)
        love.graphics.printf("Money Earned: $" .. ((difficulty / 2) + (Money / 2)), 0, 220, love.graphics.getWidth(), "center")
        ...
        for key, btn in pairs(winButtons) do
            ...
            love.graphics.rectangle("fill", drawX, drawY, drawW, drawH, 10, 10)
            love.graphics.setColor(1, 1, 1)
    ...
    function game.drawLosePopup()
        ...
        -- Draw "You Lost!" text
        love.graphics.setColor(1, 1, 1)
        local loseFont = love.graphics.newFont("source/fonts/Jersey10.ttf", 48)  -- Adjusted font size
        ...
        for key, btn in pairs(loseButtons) do
            ...
            love.graphics.setColor(0.6, 0.2, 0.2)  -- Red color for lose buttons
            love.graphics.rectangle("fill", drawX, drawY, drawW, drawH, 10, 10)
            love.graphics.setColor(1, 1, 1)
            love.graphics.printf(btn.text, drawX, drawY + (drawH / 4), drawW, "center")
        end
                ...
                for key, btn in pairs(winButtons) do
                    if x > btn.x and x < btn.x + btn.w and y > btn.y and y < btn.y + btn.h then
                        if key == "restart" then
                            ...
                            prevMoney = Money
                            winMoney = prevMoney + (((difficulty / 2) + (prevMoney / 2)))
